...
export const CarouselItem = ({ data }: { data: TProjects }) => {
  return (
    ...
    >
      <div className="absolute inset-0 flex items-center justify-center text-white text-center text-sm font-semibold opacity-0 hover:opacity-100 transition-opacity duration-300 z-10 px-2 cursor-default">
        {data.name}
      </div>
